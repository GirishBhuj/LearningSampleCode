...
public class AmericanGolf {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		if (isCookieAcceptanceWindowPresent("//*[@id='termly-code-snippet-support']/div/div/div/div/div/div/div/div[2]/button[2]")) {
			browser.findElement(By.xpath("//*[@id='termly-code-snippet-support']/div/div/div/div/div/div/div/div[2]/button[2]")).click();
		}
	
		browser.findElement(By.xpath("//*[name()='path' and contains(@class,'EGn_M-x')]")).click();
		...
		//wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[@id='CLUBS_1']//span[@class='name'][normalize-space()='Wedges']"), "Wedges"));
	
		//Click on Wedges
		
		//if (WedgeseWindowPresent("//*[@id='CLUBS_1']/ul/li[1]/ul/li[7]/a/span")) {
		if (WedgeseWindowPresent("//div[@id='CLUBS_1']//span[@class='name'][normalize-space()='Wedges']")) {
	...
	public static boolean WedgeseWindowPresent(String xpathVal)
	{
		int x = browser.findElements(By.xpath(xpathVal)).size();
		if(x==1)
		{
