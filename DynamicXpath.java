...
public class DynamicXpath {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		*/
		...
		/*
		1) /../: This part moves up one level in the DOM hierarchy from the previously selected <a> element. It navigates from 
		the <a> element to its parent element.
		2) following-sibling::td[3]: After moving up to the parent element with /../, this part selects the third <td> element that
		 is a sibling of the parent element. Specifically, it selects the third <td> element occurring after the parent element in 
